...
class Vector:
    '''Constructor -------------------------------------'''
    def __init__(self, origen, mg2ang):
    ...
    def draw(self, screen):
        ...
        pygame.draw.aaline(screen, (30, 30, 30),
...
while running:
    ...
    if keys[pygame.K_s]:
        ...
        for vector in vectores:
            o = vector.origen
            vector.mod_magnitud(np.abs(mgt_v*np.sin(t*m*2)*0.5+0.5*mgt_v) + o[0]*0.02)
    ...
    # Limitar los FPS (frame per second) a 60
